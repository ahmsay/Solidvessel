...
public class OrderConsumerContractTest extends BaseConsumerContractTest {
    ...
    void getOrdersOfCustomers() {
        var orders = List.of(
                new OrderResponse(1L, OrderStatus.DELIVERED, 5L, "26593-birmingham,-uk", LocalDateTime.of(2025, Month.MARCH, 13, 22, 45, 3, 4831), null),
                new OrderResponse(2L, OrderStatus.ON_THE_WAY, 6L, "48249-helsinki,-finland", LocalDateTime.of(2023, Month.DECEMBER, 9, 11, 49, 32, 8371), null)
        );
