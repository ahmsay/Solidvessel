...
public class UpdateAddressCommandServiceTest extends BaseUnitTest {
    ...
    void updateAddress() {
        ...
        when(addressQueryPort.getByIdAndCustomerId(1L, "123")).thenReturn(Address.builder().id(1L).customerId("123").name("home").country("turkey").city("eskisehir").zipCode("26200").build());
